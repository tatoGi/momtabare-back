...
class FrontendController extends Controller
{
    ...
    public function products(Request $request)
    {
        ...
        $transformedProducts = $products->getCollection()->map(function ($product) {
            ...
            return [
                ...
                'size' => $product->local_additional['ზომა'] ?? $product->local_additional['size'] ?? null,
                'local_additional' => $product->local_additional ?? [],
                'price' => $product->price,
    ...
    public function productShow($id)
    {
        ...
        $transformedProduct = [
            ...
            'ordered_at' => $product->ordered_at ? $product->ordered_at->format('Y-m-d H:i:s') : null,
            'rating' => $averageRating,
            'average_rating' => $averageRating,
            'ratings_count' => (int) ($product->ratings_count ?? 0),
            'ratings_amount' => (int) ($product->ratings_count ?? 0),
