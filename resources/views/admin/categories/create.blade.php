        ...
        $(document).ready(function() {
            ...
            if (typeof ClassicEditor !== 'undefined') {
                @foreach (config('app.locales') as $locale)
                    ClassicEditor
                        ...
                        .then(editor => {
                            window.categoryEditors['{{ $locale }}'] = editor;
            ...
            $('#autoTranslateBtn').on('click', function() {
                ...
                const sourceData = {
                    ...
                    description: window.categoryEditors[sourceLocale] ? window.categoryEditors[sourceLocale].getData() : ''
                };
                ...
                $.ajax({
                    url: '{{ route("admin.categories.translate", app()->getLocale()) }}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (window.categoryEditors[targetLocale]) {
                                window.categoryEditors[targetLocale].setData(response.translated.description);
                            }
