...
@if (isset($section->fields['trans']) && count($section->fields['trans']) > 0)
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item ml-auto">
            <button type="button" id="autoTranslateBtn" class="btn btn-sm btn-info waves-effect waves-light" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
                <i class="mdi mdi-translate mr-1"></i> Auto Translate
            </button>
        </li>
    </ul>
