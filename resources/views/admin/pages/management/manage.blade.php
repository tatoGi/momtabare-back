                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex justify-between items-center mb-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">
                                    ...
                                    <span class="font-medium">{{ $page->products()->count() }}</span>
                                    {{ __('admin.total products') }}
                                </p>
                            </div>
                                        ...
                                        @foreach ($recentProducts as $product)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    @else
                                                        <span
                                                            class="text-gray-400">{{ __('admin.No Category') }}</span>
                                                    @endif
                                                </td>
                                                <td
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        class="inline-flex px-2 py-1 text-xs font-semibold rounded-full {{ $product->active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="text-gray-500 mb-4">{{ __('admin.This page has no products attached yet.') }}
                                </p>
                                <a href="{{ route('admin.pages.products.create', ['locale' => app()->getLocale(), 'page' => $page->id]) }}"
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">
                                    ...
                                    <span class="font-medium">{{ $page->posts()->count() }}</span>
                                    {{ __('admin.total posts') }}
                                </p>
                            </div>
                            <div class="flex space-x-2">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach ($recentPosts as $post)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $post->active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('admin.pages.posts.destroy', ['locale' => app()->getLocale(), 'page' => $page->id, 'post' => $post->id]) }}"
                                                        class="inline">
                                                        @csrf
                                                        @method('DELETE')
