<x-admin.admin-layout>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Update promotional discount code information</p>
            </div>
    ...
    <form action="{{ route('promo-codes.update', [app()->getlocale(), $promoCode->id]) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Optional description for internal use">{{ old('description', $promoCode->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 rounded-lg p-4">
                                <p class="text-sm text-gray-600 mb-1">Current Uses</p>
                                <p class="text-2xl font-bold text-gray-800">{{ $promoCode->current_uses ?? 0 }}</p>
                            </div>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <p class="text-sm text-gray-600 mb-1">Maximum Uses</p>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('max_uses_per_user', $promoCode->max_uses_per_user) }}"
                                   min="0"
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local"
                                   name="valid_from"
                                   id="valid_from"
                                   value="{{ old('valid_from', $promoCode->valid_from ? date('Y-m-d\TH:i', strtotime($promoCode->valid_from)) : '') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local"
                                   name="valid_until"
                                   id="valid_until"
                                   value="{{ old('valid_until', $promoCode->valid_until ? date('Y-m-d\TH:i', strtotime($promoCode->valid_until)) : '') }}"
                        ...
                        <select name="product_ids[]"
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}"
                                    {{ in_array($product->id, old('product_ids', $promoCode->products->pluck('id')->toArray())) ? 'selected' : '' }}>
                        ...
                        <select name="category_ids[]"
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}"
                                    {{ in_array($category->id, old('category_ids', $promoCode->categories->pluck('id')->toArray())) ? 'selected' : '' }}>
                                    {{ $category->title }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="user_ids[]"
                            ...
                            @foreach($users as $user)
                                <option value="{{ $user->id }}"
                                    {{ in_array($user->id, old('user_ids', $promoCode->users->pluck('id')->toArray())) ? 'selected' : '' }}>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 sticky top-6">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="pt-4 border-t space-y-3">
                            <button type="submit"
                                    class="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:scale-105">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <div class="space-y-2 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold text-gray-800">{{ $promoCode->created_at->format('M d, Y') }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Updated:</span>
                                    <span class="font-semibold text-gray-800">{{ $promoCode->updated_at->format('M d, Y') }}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="text-sm text-blue-800">
                                    ...
                                    <ul class="space-y-1 text-xs">
                                        <li>• Code changes require updating customer communications</li>
                                        <li>• Consider current_uses before decreasing max_uses</li>
                                        <li>• Disabling is safer than deleting active codes</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
